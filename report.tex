...
\hline
\textcolor{red}{fused v3} & \textcolor{red}{加入 audit 候选的保守融合} & \textcolor{red}{TODO} & \textcolor{red}{TODO} & \textcolor{red}{等待服务器结果} \\
\hline
\end{tabular}
...
\begin{enumerate}
    \item \textcolor{red}{TODO：运行 fused v3，确认 audit 候选是否能带来新增正确题，且不丢失 v6/v8 的 7 道正确题。}
