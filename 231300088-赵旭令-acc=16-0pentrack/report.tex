...
最终基础任务提交建议使用 \verb|deep_research_submission_v6_docref.jsonl| 及其评估文件，OpenTrack 最终提交建议使用 \verb|deep_research_submission_fused_v6_relaxed.jsonl| 及其评估文件。最终 OpenTrack 正确题为 query id：5、53、159、314、380、651、1082、1095。
